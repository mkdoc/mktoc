...
describe('mktoc:', function() {
  ...
  it('should ignore filtered headings', function(done) {
    ...
    output.once('finish', function() {
      ...
      expect(h1Link.destination).to.eql('#heading-2');
      expect(h1Text.literal).to.eql('Heading 2')
      ...
      expect(h2Link.destination).to.eql('#heading-3');
      expect(h2Text.literal).to.eql('Heading 3');
